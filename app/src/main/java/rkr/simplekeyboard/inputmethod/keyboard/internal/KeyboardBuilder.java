...
public class KeyboardBuilder<KP extends KeyboardParams> {
    ...
    private boolean parseCaseCondition(final XmlPullParser parser) {
        ...
        try {
            ...
            final boolean showInvisibleKeyMatched = matchBoolean(caseAttr,
                    R.styleable.Keyboard_Case_showInvisibleKey, id.mShowInvisibleKey);
            final boolean selected = keyboardLayoutSetMatched && keyboardLayoutSetElementMatched
                    ...
                    && showMoreKeysMatched && showNumberRowMatched && showInvisibleKeyMatched;
