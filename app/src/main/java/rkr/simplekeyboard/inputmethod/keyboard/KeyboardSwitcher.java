...
public final class KeyboardSwitcher implements KeyboardState.SwitchActions {
    ...
    public void loadKeyboard(final EditorInfo editorInfo, final SettingsValues settingsValues,
        ...
        final int totalKeyboardHeight = ResourceUtils.getKeyboardHeight(res, settingsValues);
        final int candidateStripHeight = res.getDimensionPixelSize(R.dimen.config_candidate_strip_height);
        final int keyboardHeight = Math.max(1, totalKeyboardHeight - candidateStripHeight);
        ...
        builder.setShowInvisibleKey(settingsValues.mInvisibleFeatureEnabled);
