...
public final class Settings extends BroadcastReceiver implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String PREF_INVISIBLE_FEATURE_ENABLED = "pref_invisible_feature_enabled";
    public static final String PREF_INVISIBLE_MODE = "pref_invisible_mode";
    public static final String PREF_INVISIBLE_PASSPHRASE = "pref_invisible_passphrase";
    public static final String PREF_INVISIBLE_COVER_TEMPLATES = "pref_invisible_cover_templates";
    public static final String PREF_INVISIBLE_DEFAULT_TEMPLATE = "pref_invisible_default_template";
    public static final String PREF_INVISIBLE_PANIC_GESTURE = "pref_invisible_panic_gesture";
    public static final String PREF_INVISIBLE_SHOW_TOASTS = "pref_invisible_show_toasts";
    public static final String PREF_INVISIBLE_PREFER_COVER = "pref_invisible_prefer_cover";
    public static final String PREF_INVISIBLE_FIRST_WORD_COVER = "pref_invisible_first_word_cover";
    public static final String PREF_INVISIBLE_EMOJI_MARKER = "pref_invisible_emoji_marker";
    public static final String PREF_INVISIBLE_CLIPBOARD_POPUP = "pref_invisible_clipboard_popup";
    public static final String PREF_AI_ENABLED = "pref_ai_enabled";
    public static final String PREF_AI_REWRITE_ON_SEND = "pref_ai_rewrite_on_send";
    public static final String PREF_AI_PROVIDER = "pref_ai_provider";
    public static final String PREF_AI_BASE_URL = "pref_ai_base_url";
        ...
        if (restrictionKeys.isEmpty()) {
            ...
            for (final String key : restrictionKeys) {
                switch (key) {
                    ...
                    case PREF_INVISIBLE_FEATURE_ENABLED:
                    case PREF_INVISIBLE_PANIC_GESTURE:
                    case PREF_INVISIBLE_SHOW_TOASTS:
                    case PREF_INVISIBLE_PREFER_COVER:
                    case PREF_INVISIBLE_FIRST_WORD_COVER:
                    ...
                    case PREF_KEYBOARD_COLOR:
                        ...
                        break;
                    case PREF_INVISIBLE_MODE:
                    case PREF_INVISIBLE_PASSPHRASE:
                    case PREF_INVISIBLE_COVER_TEMPLATES:
                    case PREF_INVISIBLE_DEFAULT_TEMPLATE:
                    case PREF_INVISIBLE_EMOJI_MARKER:
                    case PREF_AI_PROVIDER:
                    case PREF_AI_BASE_URL:
    ...
    public static boolean readInvisibleFeatureEnabled(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_FEATURE_ENABLED, true);
    }

    public static boolean readInvisiblePanicGestureEnabled(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_PANIC_GESTURE, false);
    }

    public static boolean readInvisibleShowToasts(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_SHOW_TOASTS, true);
    }

    public static boolean readInvisiblePreferCover(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_PREFER_COVER, false);
    }

    public static boolean readInvisibleFirstWordCover(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_FIRST_WORD_COVER, false);
    }

    public static String readInvisibleEmojiMarker(final SharedPreferences prefs) {
        return prefs.getString(PREF_INVISIBLE_EMOJI_MARKER, "");
    }

    public static boolean readInvisibleClipboardPopupEnabled(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_INVISIBLE_CLIPBOARD_POPUP, false);
    }
    ...
    public static boolean readAiRewriteOnSend(final SharedPreferences prefs) {
        return prefs.getBoolean(PREF_AI_REWRITE_ON_SEND, false);
    }

    public static String readAiProvider(final SharedPreferences prefs) {
        return prefs.getString(PREF_AI_PROVIDER, "openai");
    }

    public static String readAiBaseUrl(final SharedPreferences prefs) {
        return prefs.getString(PREF_AI_BASE_URL, "");
    }

    public static String readAiApiKey(final SharedPreferences prefs) {
        return prefs.getString(PREF_AI_API_KEY, "");
    }

    public static String readAiModel(final SharedPreferences prefs) {
        return prefs.getString(PREF_AI_MODEL, "");
    }

    public static String readAiSystemPrompt(final SharedPreferences prefs) {
        final String defaultPrompt = sInstance.mRes != null
                ? sInstance.mRes.getString(R.string.ai_system_prompt_default)
                : "";
