...
public final class Constants {
    ...
    public static final int CODE_INVISIBLE_LOCK = -13;
    public static final int CODE_INVISIBLE_MENU = -14;
    public static final int CODE_AI_REWRITE = -15;
    ...
    public static String printableCode(final int code) {
        ...
        case CODE_INVISIBLE_LOCK: return "invisibleLock";
        case CODE_INVISIBLE_MENU: return "invisibleMenu";
        case CODE_AI_REWRITE: return "aiRewrite";
